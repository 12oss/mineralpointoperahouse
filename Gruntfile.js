	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: '_gh_pages/dist/css/mineralpointoperahouse.css'
			},
			js: {
				options: {
					separator: ';',
				...
				dest: '_gh_pages/dist/js/mineralpointoperahouse.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/mineralpointoperahouse.css',
				dest: '_gh_pages/dist/css/min/mineralpointoperahouse.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/mineralpointoperahouse.js',
				dest: '_gh_pages/dist/js/min/mineralpointoperahouse.min.js'
			}
		},
		watch: {
			css: {
